    ...
    <div class="card" style="margin: 3% 3%; ">
      ...
      <div class="card-body mb-4">
        ...
        ?>
            <div class="card">
              <div class="card-body">
                <h6><strong><img src="./dp/<?= $searchUserRow['dp'] ?>" alt="dp" width="40" /><?= $searchUserRow['name'] ?></strong><a href="./message.php?receiver=<?= $email ?>" class="btn btn-outline-primary" style="float:right">Отправить сообщение</a></h6>
              </div>
            </div>
        <?php
          }
